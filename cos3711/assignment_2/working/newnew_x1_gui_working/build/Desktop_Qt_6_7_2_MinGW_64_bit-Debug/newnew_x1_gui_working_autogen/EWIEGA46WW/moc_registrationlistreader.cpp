...
struct qt_meta_stringdata_CLASSRegistrationListReaderENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSRegistrationListReaderENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRegistrationListReaderENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject RegistrationListReader::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSRegistrationListReaderENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSRegistrationListReaderENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRegistrationListReaderENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *RegistrationListReader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSRegistrationListReaderENDCLASS.stringdata0))
